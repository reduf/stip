...
mod tests {
    ...
    fn test_with_a_key_of_less_than_64_bytes() {
        ...
        assert_eq!(
            digest,
            *b"\x75\x14\xB9\x5D\x55\x69\x1D\x53\xB6\xC1\x59\xE7\xF0\x50\x2A\x8F\x7F\xA1\x40\x6E"
        );
    }
    ...
    fn test_with_a_key_of_64_bytes() {
        ...
        assert_eq!(
            digest,
            *b"\xFC\x53\x00\x13\x60\x40\x55\x51\x0B\xBC\x9D\x35\x77\x53\x9F\x37\x0F\xD9\x5E\x8C"
        );
    }
    ...
    fn test_with_a_key_of_more_than_64_bytes() {
        ...
        assert_eq!(
            digest,
            *b"\xA3\xA3\x54\x00\x3A\x63\x3C\x3D\x85\xEB\x80\x09\xF4\x9F\x5B\x79\xA8\x86\x5A\xE2"
        );
    }
}
